# A Minimal CORE RMS Astro site with Sanity Studio by The Grovery
...
PUBLIC_SANITY_PROJECT_ID="33hyzhug"
...
1. Visit the Studio and create and publish a new `Resource` document for a new Resource Card and Details Page.
2. Visit the Studio and create and publish a `NavBlock` document for a new Navigation block for the homepage.
3. Visit the Studio and create and publish a `Step` document for a new Learn RMS step onn the learn page plus a detailed learn step page.
